...
public class ControllerClient implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        pss.readDefaultPosition(false,false);
    ...
    public void clickedOnPath(MouseEvent mouseEvent) {
        ...
        if (chessPieceSelected && lastSelectedX!=-1 && lastSelectedY!=-1) {
            ...
            pss.printState();
            //pss.transCurrentToFile(false,"0000");
    ...
    public void onConnectClicked(ActionEvent mouseEvent) {
        //System.out.println(IPTextField.getText());
        IPConnect = IPTextField.getText();
    }
}
